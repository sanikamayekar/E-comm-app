...
export default function Navbar() {
  ...
  useEffect(() => {
    if (pathname === '/') {
      ...
      // Don't change activeLink if it's already a product category
      // This allows the last clicked product category to stay active
      setActiveLink(prevActive => 
        ['BAG', 'SNEAKERS', 'BELT'].includes(prevActive) ? prevActive : ''
      );
    } else {
      setActiveLink('');
    }
